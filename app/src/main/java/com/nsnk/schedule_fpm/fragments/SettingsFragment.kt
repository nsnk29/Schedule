...
import com.nsnk.schedule_fpm.BuildConfig
...
import com.nsnk.schedule_fpm.activities.SettingsActivity
import java.util.*
...
class SettingsFragment : PreferenceFragmentCompat() {
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        aboutPreference?.setOnPreferenceClickListener {
            Toast.makeText(context, "Версия ${BuildConfig.VERSION_CODE}\n${it.context.getString(R.string.about_string)}", Toast.LENGTH_SHORT).show()
            true
        }
    }
}